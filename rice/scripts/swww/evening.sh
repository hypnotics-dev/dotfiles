...
IMG_SOURCE_SWWW_EV="$HOME/stuff/images/wallpaper/active/evening/"
IMG_PREV_SWWW_EV1="$HOME/stuff/images/wallpaper/active/prev/eve1"
IMG_PREV_SWWW_EV2="$HOME/stuff/images/wallpaper/active/prev/eve2"
...
notify-send --app-name=Wallpaper "Switching to EVENING theme" --icon="/home/hypnotics/.local/share/icons/customs/evening.png"
