...
IMG_SOURCE_SWWW_EV="$HOME/stuff/images/wallpaper/active/morning//"
IMG_PREV_SWWW_EV1="$HOME/stuff/images/wallpaper/active/prev/mo1"
IMG_PREV_SWWW_EV2="$HOME/stuff/images/wallpaper/active/prev/mo2"
...
notify-send --app-name="Wallpaper" "Switching to MORNING theme" --icon="/home/hypnotics/.local/share/icons/customs/morning.png"
